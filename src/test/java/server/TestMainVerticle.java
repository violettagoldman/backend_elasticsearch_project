...
public class TestMainVerticle {
  ...
  @Test
  void ping_node_1(Vertx vertx, VertxTestContext testContext) throws Throwable {
  ...
  @Test
  void ping_node_master(Vertx vertx, VertxTestContext testContext) throws Throwable {
    WebClient client = WebClient.create(vertx);
    JsonObject params = new JsonObject();
  ...
  @Test
  void wrong_route(Vertx vertx, VertxTestContext testContext) throws Throwable {
    WebClient client = WebClient.create(vertx);
    JsonObject params = new JsonObject();
    params.put("node", "master");
  ...
  @Test
  void get(Vertx vertx, VertxTestContext testContext) throws Throwable {
    WebClient client = WebClient.create(vertx);
    JsonObject params = new JsonObject();
  ...
  @Test
  void createindex(Vertx vertx, VertxTestContext testContext) throws Throwable {
    WebClient client = WebClient.create(vertx);
    JsonObject params = new JsonObject();
  ...
  @Test
  void createtable(Vertx vertx, VertxTestContext testContext) throws Throwable {
    WebClient client = WebClient.create(vertx);
    JsonObject params = new JsonObject();
  ...
  @Test
  void uploadcsv(Vertx vertx, VertxTestContext testContext) throws Throwable {
    WebClient client = WebClient.create(vertx);
    JsonObject params = new JsonObject();
